...
palmerpenguins::penguins %>% drop_na() %>% 
  ...
  theme(plot.subtitle = element_markdown(size = 40)) + 
  facet_grid(~sex)
...
`r flipbookr:::chunq_reveal("colplot-gapminder", title = "Column Plot", lcolw = "40", rcolw = "60", chunk_options = "fig.height = 8, fig.width = 10", smallcode = TRUE)`


---

```{r}
#| label: colplot-gapminder1
#| echo: false
#| eval: false
...
`r flipbookr:::chunq_reveal("colplot-gapminder1", title = "Column Plot", lcolw = "40", rcolw = "60", chunk_options = "fig.height = 8, fig.width = 10", smallcode = TRUE)`


---

```{r}
#| label: colplot-gapminder2
#| echo: false
#| eval: false
...
dslabs::gapminder %>% 
  ...
  labs(caption = "@Data Gapminder (WHO)",
       ...
       x = "") +
  geom_point(colour = "firebrick4", size = 4) + 
  geom_segment(size = 2, colour = "firebrick4", y = 0) + geom_point(colour = "firebrick4", size = 4) + 
  labs(x = "") #BREAK
  
```


`r flipbookr:::chunq_reveal("colplot-gapminder2", title = "Column Plot", lcolw = "40", rcolw = "60", chunk_options = "fig.height = 8, fig.width = 10", smallcode = TRUE)`
...
`r flipbookr:::chunq_reveal("lollypop-gapminder", title = "Lollypop Plot", lcolw = "40", rcolw = "60", chunk_options = "fig.height = 8, fig.width = 10", smallcode = TRUE)`
