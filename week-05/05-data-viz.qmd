...
`r flipbookr:::chunq_reveal("colplot-gapminder", title = "Column Plot", lcolw = "40", rcolw = "60", chunk_options = "fig.height = 8, fig.width = 10", smallcode = TRUE, break_type = "rotate")`
