...
1)  Introduction to Statistical Computing & R - *Saturday April 5th*

2)  Getting and Cleaning Data - *Saturday April 12th*

3)  Manipulating Data - *Saturday April 26th*

4)  Statistical Inference - *Saturday May ??*

5)  Data Visualisation - *Saturday June ??*
...
1. also great at making documents and presentations using [quarto](https://quarto.org/){target="_blank"}
...
-   [Fundamentals of Data Visualization by Wilke](https://clauswilke.com/dataviz/){target="_blank"}, lots of his actual code is on github at <https://github.com/clauswilke/practical_ggplot2>{target="_blank"}
-   Data Visualization by Kieran Healy (ISBN = 978-0691181622). \~€25. Also online at <https://socviz.co/index.html>{target="_blank"}
